...
```
As expected the estimated mean out of test accuracy is `r estOutSample` which is greater than the in train accuracy ( `r estInSample` ). Our calculations estimate an out of sample error of `r 1-estOutSample`.
