...
```
As expected the estimated mean out of sample accuracy is `r estOutSample` which is less than the in sample accuracy ( `r estInSample` ). Our calculations estimate an out of sample error of `r 1-estOutSample`.
